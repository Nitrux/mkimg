...
base_img_url=http://cdimage.ubuntu.com/ubuntu-base/releases/18.04.5/release/ubuntu-base-18.04.5-base-amd64.tar.gz
...
mksquashfs $build_dir $iso_dir/casper/filesystem.squashfs -comp gzip -no-progress -b 262144
